...
//! 1 manipulate .style property changes
...
//* Supaprastinant uzduoti:

const [first, second, third] = document.querySelectorAll("h1, h2, h3");
first.style.color = "crimson";
first.style.fontSize = "30px";

second.setAttribute("style", "color: crimson; font-size: 30px;");

third.style.cssText = "color: crimson; font-size: 30px;";
